...
<body>
    ...
    <div class="bottom">
        ...
        <form action="#" method="post">
            ...
            <label for="doj" class="doj">
                APD
                <input type="date" name="apd" required />
            </label>
            <label for="course">
                Qualification
                <input type="text" name="course" placeholder="Enter Qualification" required>
            </label>
            <label for="course">
                Salary
                <input type="text" name="course" placeholder="Enter Salary" required>
            </label>
